...
const endpoint = `${baseUrl}/api/internal/academic-integrity/protected-markers`;
...
if (!apply || Number(preview.candidateCount || 0) === 0) {
  console.log(apply ? "No repair is needed." : "Dry run only. Re-run with --apply after reviewing the preview.");
  process.exit(0);
}

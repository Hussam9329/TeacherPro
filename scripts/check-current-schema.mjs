...
try {
 ...
 for(const name of ['tp_sync_exam_course_projection_trg','tp_exam_course_projection_guard','tp_revoke_changed_credentials','tp_assign_exam_chapter','tp_active_chapter_opportunity_scope','tp_reset_dismissed_check_trg']) if(!triggers.includes(name)) throw new Error(`Missing runtime database guard: ${name}`);

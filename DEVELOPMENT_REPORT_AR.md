...
- حذف الطالب يحذف درجاته وحركاته والرسائل التابعة له.
- حذف الامتحان يحذف درجاته وحركات الفرص التابعة له.
...
### الحسابات التجريبية
- المدير: يُضبط عبر `TEACHERPRO_ADMIN_PASSWORD` في متغيرات البيئة.
- المصحح: يُضاف من صفحة إدارة الحسابات داخل النظام.

...
const UI_REPLACEMENTS: Array<[RegExp, string]> = [
  [/تثبيت تعهد/g, "تسجيل متابعة تاريخية"],
  [/إلغاء تعهد/g, "إلغاء متابعة تاريخية"],
  [/رصيد بعد تعهد/g, "رصيد إعادة التفعيل"],
  [/تعهد ولي الأمر/g, "متابعة تاريخية"],
  [/بعد التعهد/g, "بعد إعادة التفعيل"],
  [/بعد تعهد/g, "بعد إعادة التفعيل"],
  [/تعهد أول/g, "إعادة تفعيل أولى"],
  [/تعهد ثانٍ/g, "إعادة تفعيل ثانية"],
  [/التعهدات/g, "المتابعة التاريخية"],
  [/التعهد/g, "إعادة التفعيل"],
  [/تعهد/g, "إعادة تفعيل"],

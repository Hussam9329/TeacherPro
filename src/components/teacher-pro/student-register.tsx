          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <section className="surface-card p-5 md:p-6">
              ...
              <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-8">
                    <label className="inline-flex cursor-pointer items-center">
                      <input type="radio" id="reg-gender-male" name="gender" value="ذكر" checked={form.gender === 'ذكر'} onChange={() => updateForm('gender', 'ذكر')} required className="h-5 w-5 accent-primary" />
                      <span className="mr-2 font-medium text-foreground">ذكر</span>
                    </label>
                    <label className="inline-flex cursor-pointer items-center">
                      <input type="radio" id="reg-gender-female" name="gender" value="أنثى" checked={form.gender === 'أنثى'} onChange={() => updateForm('gender', 'أنثى')} required className="h-5 w-5 accent-primary" />
                ...
                <div className="space-y-2">
                  <Label htmlFor="reg-telegram" className="font-bold text-foreground">معرف التليكرام</Label>
                  <div className="relative">
                    <FieldIcon icon={Send} />
                    <Input
                ...
                <div className="space-y-2">
                  <Label htmlFor="reg-phone" className="font-bold text-foreground">رقم هاتف الطالب <RequiredMark /></Label>
                  <div className="relative">
                ...
                <div className="space-y-2">
                  <Label htmlFor="reg-parentPhone" className="font-bold text-foreground">رقم هاتف ولي الأمر <RequiredMark /></Label>
                  <div className="relative">
            ...
            <section className="surface-card p-5 md:p-6">
              ...
              <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="reg-courseType" className="font-bold text-foreground">نوع الدورة <RequiredMark /></Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="reg-courseId" className="font-bold text-foreground">الدورة <RequiredMark /></Label>
              ...
              <div className="mt-6 grid grid-cols-1 gap-5 md:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="reg-mainSite" className="font-bold text-foreground">الموقع الرئيسي <RequiredMark /></Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="reg-subSite" className="font-bold text-foreground">الموقع الفرعي {subSiteOptions.length > 0 && <RequiredMark />}</Label>
                ...
                <div className="space-y-2 md:col-span-2">
                  <Label htmlFor="reg-groupId" className="font-bold text-foreground">الكروب الإلكتروني <RequiredMark /></Label>

            ...
            <div className="flex flex-col gap-4 xl:flex-row-reverse xl:items-end xl:justify-between">
              <div className="grid w-full gap-3 lg:grid-cols-[minmax(14rem,1fr)_minmax(18rem,1fr)] lg:items-stretch xl:max-w-3xl">
                ...
                <div
                  ...
                  title="يُحتسب جميع السجلات اليدوية: الرقمية + قبل التسجيل + المعلقة للمراجعة + المفصولين + المجازين + فترة السماح. لا تُحتسب الحالات التلقائية (غياب تلقائي فقط) ولا أوراق انتظار التصحيح (درجة بدون رقم قادمة من التصحيح الإلكتروني/بوت تلغرام)"
                >
              ...
              {examStudents.length === 0 ? (
                ...
                visibleExamStudents.map((student) => {
                  ...
                  const effectiveSaveState =
                    explicitSaveState?.phase === "pending" &&

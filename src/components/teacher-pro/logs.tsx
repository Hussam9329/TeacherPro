...
const logExportColumns: ExportColumn<Record<string, unknown> ExportColumn<Record<string, unknown>> { index?: number; student?: Record<string, unknown>; grade?: Record<string, unknown>; exam?: Record<string, unknown>; cls?: { text?: string }; courseName?: string; }>[] = [
      ...
      <Card>
        <CardContent className="p-4">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
            ...
            <div className="space-y-1">
              <Label htmlFor="logs-user" className="text-xs">
                المستخدم
              </Label>
              <Select
                name="userId"
            ...
            <div className="space-y-1">
              ...
              >
                <SelectTrigger id="logs-pageSize" className="h-9">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
